Shader "PBR Master"
{
    Properties
    {
        Color_BF3303A0("ColorBase", Color) = (0.07058824,0.1607843,0.1529412,0)
    ...
    SubShader
    {
        ...
        inline float2 unity_voronoi_noise_randomVector (float2 UV, float offset)
        {
            ...
            VertexDescription PopulateVertexData(VertexDescriptionInputs IN)
            {
                ...
                float _Split_49E7322C_R_1 = IN.WorldSpacePosition[0];
                float _Split_49E7322C_G_2 = IN.WorldSpacePosition[1];
                float _Split_49E7322C_B_3 = IN.WorldSpacePosition[2];
                float _Split_49E7322C_A_4 = 0;
                float4 _Combine_690F97BF_RGBA_4;
                float3 _Combine_690F97BF_RGB_5;
                float2 _Combine_690F97BF_RG_6;
                Unity_Combine_float(_Split_49E7322C_R_1, _Split_49E7322C_B_3, 0, 0, _Combine_690F97BF_RGBA_4, _Combine_690F97BF_RGB_5, _Combine_690F97BF_RG_6);
                float _Property_27AA5723_Out_0 = Vector1_221A0FD9;
                float2 _Multiply_9915511D_Out_2;
                Unity_Multiply_float(_Combine_690F97BF_RG_6, (_Property_27AA5723_Out_0.xx), _Multiply_9915511D_Out_2);
            ...
            SurfaceDescription PopulateSurfaceData(SurfaceDescriptionInputs IN)
            {
                ...
                float4 _Property_23FE3CE_Out_0 = Color_BF3303A0;
                float _Split_B9847336_R_1 = IN.WorldSpacePosition[0];
                float _Split_B9847336_G_2 = IN.WorldSpacePosition[1];
                float _Split_B9847336_B_3 = IN.WorldSpacePosition[2];
                float _Split_B9847336_A_4 = 0;
                float4 _Combine_EE24E6F2_RGBA_4;
                float3 _Combine_EE24E6F2_RGB_5;
                float2 _Combine_EE24E6F2_RG_6;
                Unity_Combine_float(_Split_B9847336_R_1, _Split_B9847336_B_3, 0, 0, _Combine_EE24E6F2_RGBA_4, _Combine_EE24E6F2_RGB_5, _Combine_EE24E6F2_RG_6);
                float _Property_EA233F6C_Out_0 = Vector1_221A0FD9;
                float2 _Multiply_5FBCC94C_Out_2;
                Unity_Multiply_float(_Combine_EE24E6F2_RG_6, (_Property_EA233F6C_Out_0.xx), _Multiply_5FBCC94C_Out_2);

                float _Property_E794697D_Out_0 = Vector1_3E734ED8;
                float _Multiply_F27D3501_Out_2;
                Unity_Multiply_float(_Time.y, _Property_E794697D_Out_0, _Multiply_F27D3501_Out_2);

                float _Property_DF2E142D_Out_0 = Vector1_30FC0A4B;
                float _Voronoi_EDF64014_Out_3;
                float _Voronoi_EDF64014_Cells_4;
                Unity_Voronoi_float(_Multiply_5FBCC94C_Out_2, _Multiply_F27D3501_Out_2, _Property_DF2E142D_Out_0, _Voronoi_EDF64014_Out_3, _Voronoi_EDF64014_Cells_4);
                float _Property_F9D7714D_Out_0 = Vector1_8FDC4159;
                float _Power_B15F028A_Out_2;
                Unity_Power_float(_Voronoi_EDF64014_Out_3, _Property_F9D7714D_Out_0, _Power_B15F028A_Out_2);
                float4 _Property_7F4EBE75_Out_0 = Color_5856042A;
                float4 _Multiply_73F5CD9F_Out_2;
                Unity_Multiply_float((_Power_B15F028A_Out_2.xxxx), _Property_7F4EBE75_Out_0, _Multiply_73F5CD9F_Out_2);

                float4 _Add_CA03B711_Out_2;
                Unity_Add_float4(_Property_23FE3CE_Out_0, _Multiply_73F5CD9F_Out_2, _Add_CA03B711_Out_2);
                ...
                float _FresnelEffect_50DAADA4_Out_3;
                Unity_FresnelEffect_float(IN.WorldSpaceNormal, IN.WorldSpaceViewDirection, 1, _FresnelEffect_50DAADA4_Out_3);
                float4 _Lerp_E847765E_Out_3;
                Unity_Lerp_float4(Color_99AF311E, Color_10D69FE0, (_FresnelEffect_50DAADA4_Out_3.xxxx), _Lerp_E847765E_Out_3);
                float4 _Add_D22EED0_Out_2;
                Unity_Add_float4(_Add_CA03B711_Out_2, _Lerp_E847765E_Out_3, _Add_D22EED0_Out_2);
                ...
                float _Subtract_16485B81_Out_2;
                Unity_Subtract_float(_Multiply_6845176C_Out_2, _Subtract_F97CE56A_Out_2, _Subtract_16485B81_Out_2);
                float _Property_D66A6F28_Out_0 = Vector1_3AE69E57;
                float _Multiply_37E15C12_Out_2;
                Unity_Multiply_float(_Subtract_16485B81_Out_2, _Property_D66A6F28_Out_0, _Multiply_37E15C12_Out_2);
